...
namespace NetCoreMVCSample.Migrations
{
    ...
    [Migration("20210327212312_IdentityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetCoreMVCSample.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("NetCoreMVCSample.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("NetCoreMVCSample.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("NetCoreMVCSample.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NetCoreMVCSample.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("NetCoreMVCSample.Models.OrderDetail", b =>
                {
                    b.HasOne("NetCoreMVCSample.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NetCoreMVCSample.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NetCoreMVCSample.Models.Pie", b =>
                {
                    b.HasOne("NetCoreMVCSample.Models.Category", "Category")
                        .WithMany("Pies")
